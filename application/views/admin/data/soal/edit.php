                ...
                <form class="form-horizontal" method="post" action="<?=site_url('admin/soal/edit')?>">
                  ...
                  <div class="control-group">
                    <label class="checkbox inline" for="pilihan_a">
                      <input type="radio" value="a" name="jawaban" <?=($data->jawaban=='a')?'checked':''?>>
                      <div class="input-prepend">
                    ...
                    <label class="checkbox inline" for="pilihan_b">
                      <input type="radio" value="b" name="jawaban" <?=($data->jawaban=='b')?'checked':''?>>
                      <div class="input-prepend">
                    ...
                    <label class="checkbox inline" for="pilihan_c">
                      <input type="radio" value="c" name="jawaban" <?=($data->jawaban=='c')?'checked':''?>>
                      <div class="input-prepend">
                    ...
                    <label class="checkbox inline" for="pilihan_d">
                      <input type="radio" value="d" name="jawaban" <?=($data->jawaban=='d')?'checked':''?>>
                      <div class="input-prepend">
