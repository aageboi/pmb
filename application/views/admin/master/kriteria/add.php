                ...
                <form class="form-horizontal" method="post">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <select name="pelajaran" id="pelajaran" class="span3">
                        ...
                        <option value="<?=$val?>" <?=(isset($data['pelajaran'])&&$data['id_pelajaran']==$val)?'selected':''?>><?=$text?></option>
                        <?php } ?>
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="control-group">
                    <div class="controls">
                        ...
                        <a href="<?=site_url('admin/kriteria')?>" class="btn"><i class="icon-remove"></i> Batal</a>
                    </div>
                  </div>
                </form>
            </div><!--/span-->
