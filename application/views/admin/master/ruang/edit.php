        ...
        <div class="span9">
          <div class="row-fluid">
            <div class="span12">
                ...
                <form class="form-horizontal" method="post" action="<?=site_url('admin/ruang/edit')?>">
                  <?=$this->load->view('admin/error_message')?>
                  <div class="control-group">
                    <label class="control-label" for="nama">Ruang</label>
                    <div class="controls">
                      <input type="text" id="nama" placeholder="nama" name="nama" value="<?=isset($data->nama_ruang) ? $data->nama_ruang : ''?>">
                    </div>
                  </div>
                  <div class="control-group">
